...
(comment
  ...
  (solution-1 (-> "resources/input/2024/input_04" slurp vdata))) ;; 2633

(defn s1 []
  (solution-1 (-> "resources/input/2024/input_04" slurp vdata)))
...
(comment 
  ...
  (solution-2 (-> "resources/input/2024/input_04" slurp vdata))) ;; 1936

(defn s2 []
  (solution-2 (-> "resources/input/2024/input_04" slurp vdata)))
